...
<main>
    ...
    <form action="" method="POST">
        <select name="path" id="path" style='height: 29px;'>
            ...
            <!-- B.com Result-->
                <option value='../../Results/B.com Sem-1/'>/Results/BBA Sem-1/</option>
                <option value='../../Results/B.com Sem-2/'>/Results/BBA Sem-2/</option>
                <option value='../../Results/B.com Sem-3/'>/Results/BBA Sem-3/</option>
                <option value='../../Results/B.com Sem-4/'>/Results/BBA Sem-4/</option>
                <option value='../../Results/B.com Sem-5/'>/Results/BBA Sem-5/</option>
                <option value='../../Results/B.com Sem-6/'>/Results/BBA Sem-6/</option>
        </select><p>
