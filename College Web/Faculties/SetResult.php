...
if($Count2 == 1){
    echo "<h4 style='color: red;'>Enter Valid SPUID.</h4>";
        ...
        <p>
          ...
          <input type="text" name="Username" value="<?php echo $_SESSION['Username']; ?>" hidden>
            ...
            <input type="text" name="PassingMarks" value="<?php echo $_SESSION['PassingMarks']; ?>" hidden>
    ...
    <?php if(isset($_POST['WholeClassResultDeclared'])){
       ...
       if($_SERVER['REQUEST_METHOD'] and isset($_POST['Result'])){
        ...
        $sql = "INSERT INTO `Results`(SPU_ID, Name, Class, S1, S2, S3, S4, S1M, S2M, S3M, S4M, Total, PassingMarks, Obtained) VALUES('$Spuid', '$Name', '$Class', '$S1', '$S2', '$S3', '$S4', '$S1M', '$S2M', '$S3M', '$S4M', '$Total', $Passing', ' $Obtained')";
        ...
        if($Class == 'BCA-5' or $Class == 'BCA-6'){
            $sql = "INSERT INTO `Results`(SPU_ID, Name, Class, S1, S2, S3, S1M, S2M, S3M, Total, PassingMarks, Obtained) VALUES('$Spuid', '$Name', '$Class', '$S1', '$S2', '$S3', '$S1M', '$S2M', '$S3M', '$Total', '$Passing', '$Obtained')";
            if(mysqli_query($conn, $sql)){
            ...
            $sql = "INSERT INTO `Results`(SPU_ID, Name, Class, S1, S2, S3, S4, S5, S6, S7, S8, S1M, S2M, S3M, S4M, S5M, S6M, S7M, S8M, Total, PassingMarks, Obtained) VALUES('$Spuid', '$Name', '$Class', '$S1', '$S2', '$S3', '$S4', '$S5', '$S6', '$S7', '$S8', '$S1M', '$S2M', '$S3M','$S4M', '$S5M', '$S6M','$S7M', '$S8M', '$Total', '$Passing', '$Obtained')";
            if(mysqli_query($conn, $sql)){
