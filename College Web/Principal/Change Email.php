...
if (empty($_SESSION['Username'] && $_SESSION['Password']) || $_SESSION['Login_type'] != 'Principal') {        
...
if(isset($_POST['Reset']))
{
    ...
    //Principal
    $sql = "SELECT Email FROM `Login` WHERE Login_type='Principal'";
   ...
   if($_SESSION['Login_type'] == "Principal")
   {
    ...
    //Principal new Email
    if($_SESSION['Login_type'] == 'Principal' && $Count != 1){
        $sql = "UPDATE `Login` SET Email='$Email' WHERE Login_Type='Principal'";
