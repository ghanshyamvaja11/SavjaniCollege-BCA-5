  ...
  <div style="background: skyblue; border-radius: 29px;">
      <center>
          <form action="" method="POST">
            <input type="Number" name="SPUID" style='Height: 29.8px; Width: 150px;' id="SPUID1" placeholder="Enter Your SPUID*" required><br class="Space"><br class="Space">
...
$Spuid = $_POST['SPUID'];
$sql = "SELECT SPU_ID FROM `Results` WHERE SPU_ID = '$Spuid'";
