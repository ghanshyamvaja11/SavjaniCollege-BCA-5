<?php
session_start();
if (empty($_SESSION['Username'] && $_SESSION['Password']) || empty($_SESSION['Login_type'])) {        
...
if(isset($_POST['Reset']))
{
    ...
    //Principal
    $sql = "SELECT Email FROM `Student Registration` WHERE SPU_ID=$Username";
   ...
   if($_SESSION['Login_type'] == 'Student')
   {
    ...
    if($_SESSION['Login_type'] == 'Student' && $Count != 1){
        $sql = "UPDATE `Student Registration` SET Email='$Email' WHERE SPU_ID='$Username'";
